...
export function Step24_BadHabits({ onNext }: StepProps) {
  const [selected, setSelected] = useState<string[]>([])

  const options = [
    { id: "emocao", label: "Comer por emoção ou tédio" },
    { id: "comer_demais", label: "Comer demais" },
    { id: "lanches_noturnos", label: "Lanches noturnos" },
    { id: "pular_refeicoes", label: "Pular refeições com frequência" },
  ...
  const toggleOption = (id: string) => {
    ...
    setSelected(prev => {
      // Se "nenhum" estiver marcado, desmarca ao selecionar outra coisa
