...
function useCountdown(minutesTotal: number) {
  const [seconds, setSeconds] = useState(() => {
    ...
    try {
      sessionStorage.setItem("promo_end", String(end));
    } catch {
      /* ignore */
    }
    ...
    <div className="w-full flex justify-center bg-background min-h-screen pb-8">
      <div className="w-full max-w-lg bg-surface-card shadow-xl overflow-hidden relative flex flex-col">
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex gap-1">
                    ...
                    {[0, 1, 2, 3].map((i) => (
                      <div
                        key={i}
                        className="h-1.5 flex-1 bg-surface-subtle rounded-full"
                      ></div>
                    ))}
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex gap-1">
                    {[0, 1, 2, 3, 4].map((i) => (
                      <div
                        key={i}
                        className="h-1.5 flex-1 bg-status-success rounded-full"
                      ></div>
                    ))}
                  </div>
                </div>
        ...
        <section className="px-5 py-6 bg-surface-subtle">
          <h3 className="text-lg font-heading font-bold text-text-primary mb-4 text-center">
          ...
          <div className="border border-primary rounded-xl overflow-hidden shadow-lg bg-surface-card transform hover:scale-[1.01] transition-transform">
            ...
            <div className="p-5 flex items-center justify-between">
              ...
              <div className="text-right w-1/2">
                <div className="text-xs text-text-secondary uppercase font-semibold mb-1">
                  Por apenas
                </div>
          ...
          <div className="bg-surface-card rounded-2xl p-6 shadow-sm border border-border">
            <ul className="space-y-4">
              {[
                {
                  emoji: "🔥",
                  text: "Barriga mais reta e corpo firme — sem academia, sem aparelho",
                },
                {
                  emoji: "😌",
                  text: "Fim das dores nas costas que te impedem de viver bem",
                },
                {
                  emoji: "⚡",
                  text: "Energia de manhã para encarar o dia — acaba aquela preguiça crônica",
                },
                {
                  emoji: "😍",
                  text: "Autoestima lá em cima — você vai se olhar no espelho com orgulho",
                },
                {
                  emoji: "🧘",
                  text: "Menos ansiedade e estresse — o treino vira seu momento de paz",
                },
                {
                  emoji: "💪",
                  text: "Postura corrigida e pernas sem cãibras — corpo funcionando de verdade",
                },
                {
                  emoji: "🩸",
                  text: "Ciclo menstrual mais tranquilo — as dores reduzem com o movimento",
                },
                {
                  emoji: "🌀",
                  text: "Flexibilidade melhorada — seu corpo começa a se mover com leveza",
                },
              ].map((item, idx) => (
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-surface-elevated rounded-xl p-4 shadow-sm border border-border flex flex-col items-center text-center gap-3">
              ...
              <p className="text-xs font-semibold uppercase text-text-secondary">
                das alunas perde mais de 7kg durante o programa
              </p>
            </div>
            <div className="bg-surface-elevated rounded-xl p-4 shadow-sm border border-border flex flex-col items-center text-center gap-3">
              <div className="relative w-20 h-20">
              ...
              <p className="text-xs font-semibold uppercase text-text-secondary">
                das alunas alega ter mais disposição após início
              </p>
            </div>
          </div>
        </section>
            ...
            {[
              <>
                <span className="font-bold">
                  Sequência de treinos passo a passo
                </span>{" "}
                — organizada por semana, do mais fácil ao mais desafiador
              </>,
              <>
                <span className="font-bold">
                  Exercícios de 10 a 20 min por dia
                </span>{" "}
                — que cabem na rotina de qualquer mulher ocupada
              </>,
              <>
                <span className="font-bold">Zero equipamentos</span> — tudo o
                que você precisa é do seu próprio peso e vontade
              </>,
              <>
                <span className="font-bold">Foco nos pontos certos</span> —
                barriga, glúteos, braços e pernas no mesmo programa
              </>,
              <>
                <span className="font-bold">
                  Guia de treino + dicas de estilo de vida
                </span>{" "}
                — para manter os resultados depois
              </>,
            ].map((content, i) => (
              <div
                key={i}
                className="flex gap-4 items-start bg-surface-card p-4 rounded-xl shadow-sm"
              >
        ...
        <section className="px-5 py-10 text-center">
          <h3 className="text-xl font-heading font-bold mb-4">
            Como vou receber meu plano?
          </h3>
          <p className="text-sm text-text-secondary mb-3 leading-relaxed">
            Após finalizar seu cadastro, você recebe um e-mail imediatamente com
            o link de acesso ao seu plano personalizado.
          </p>
          <p className="text-sm text-text-secondary mb-8 leading-relaxed">
            O plano é entregue em formato digital — você lê no celular, tablet
            ou computador. Tudo organizado, passo a passo, do aquecimento até os
            exercícios do dia.
          </p>
          <div className="grid grid-cols-1 gap-3 max-w-xs mx-auto">
            {[
              ...
              <div
                key={i}
                className="border border-border rounded-lg py-3 px-4 text-sm font-semibold text-text-primary shadow-sm bg-surface-card"
              >
                {ft}
              </div>
            ))}
        ...
        <section className="px-5 py-10 bg-primary/5">
          ...
          <div className="space-y-6">
            {[
              {
                num: "4.684",
                desc: "Alunas perderam mais de 5 quilos após 25 dias de plano",
              },
              {
                num: "97%",
                desc: "Das alunas indicam o programa para amigas e familiares",
              },
              {
                num: "75%",
                desc: "Das alunas reduziram dores no corpo ainda no primeiro mês",
              },
            ].map(({ num, desc }, i) => (
              <div key={i} className="text-center">
                ...
                <p className="text-sm font-medium text-text-secondary max-w-xs mx-auto">
                  {desc}
                </p>
              </div>
            ))}
        ...
        <section className="px-5 py-10 bg-surface-subtle border-y border-border">
          ...
          <p className="text-center text-sm text-text-secondary mb-8">
            Incluso no seu plano sem nenhum custo extra
          </p>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-[10px] font-black bg-primary text-white px-2 py-0.5 rounded-full uppercase tracking-wider">
                    Bônus #1
                  </span>
                </div>
                <h4 className="font-heading font-black text-text-primary mb-1">
                  Comunidade Exclusiva no WhatsApp
                </h4>
                <p className="text-xs text-text-secondary leading-relaxed">
                  Acesso ao grupo com outras alunas que estão no mesmo caminho.
                  Troca de experiências, motivação diária e suporte para não
                  desistir.
                </p>
                <p className="text-xs font-bold text-primary mt-2">
                  Valeria R$47,00 por si só
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex-1">
                ...
                <h4 className="font-heading font-black text-text-primary mb-1">
                  E-book: Dietas Low Carb para Performance
                </h4>
                <p className="text-xs text-text-secondary leading-relaxed">
                  Guia completo de alimentação low carb para potencializar seus
                  resultados — sem passar fome, sem complicação. O que comer
                  antes e depois do treino.
                </p>
                <p className="text-xs font-bold text-primary mt-2">
                  Valeria R$37,00 por si só
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex-1">
                ...
                <h4 className="font-heading font-black text-text-primary mb-1">
                  Sorteio Mensal de Kit Treino em Casa
                </h4>
                <p className="text-xs text-text-secondary leading-relaxed">
                  Todo mês uma aluna ganha um kit completo de treino em casa —
                  tapete, elásticos e acessórios. Só por fazer parte do
                  programa.
                </p>
                <p className="text-xs font-bold text-primary mt-2">
                  Sorteio exclusivo para alunas ativas
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="mt-6 bg-primary/10 rounded-xl p-4 text-center border border-primary/20">
            ...
            <p className="text-lg font-black text-text-secondary line-through mb-0.5">
              R$ 153,80
            </p>
        ...
        <section className="px-5 py-10">
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <span className="text-xs font-black uppercase tracking-widest text-status-success">
              Resultados Reais
            </span>
          </div>
          ...
          <p className="text-center text-sm text-text-secondary mb-8">
            Prints do nosso grupo de WhatsApp
          </p>
              ...
              <div className="bg-[#e5ddd5] px-3 py-4 space-y-2">
                ...
                <div className="flex justify-start">
                  <div className="bg-white rounded-t-xl rounded-br-xl rounded-bl-sm px-3 py-2 max-w-[80%] shadow-sm">
                    <p className="text-[13px] text-zinc-800 leading-snug">
                      Gente, 2ª semana e já sinto diferença 😭🙌
                    </p>
                ...
                <div className="flex justify-start">
                  <div className="bg-white rounded-t-xl rounded-br-xl rounded-bl-sm overflow-hidden shadow-sm max-w-[75%]">
                    ...
                    />
                    <div className="text-[10px] text-zinc-400 text-right px-3 pb-2">
                      10:33 ✓✓
                    </div>
                  </div>
                </div>
                ...
                <div className="flex justify-start">
                  <div className="bg-white rounded-t-xl rounded-br-xl rounded-bl-sm px-3 py-2 max-w-[82%] shadow-sm">
                    <p className="text-[13px] text-zinc-800 leading-snug">
                      Fiz só 15 min hoje e to suada igual academia 😂 nunca
                      pensei que em casa fosse assim
                    </p>
                    <div className="text-[10px] text-zinc-400 text-right mt-1">
                      10:34 ✓✓
                    </div>
              ...
              <div className="bg-[#e5ddd5] px-3 py-4 space-y-2">
                <div className="flex justify-start">
                  <div className="bg-white rounded-t-xl rounded-br-xl rounded-bl-sm px-3 py-2 max-w-[85%] shadow-sm">
                    <p className="text-[13px] text-zinc-800 leading-snug">
                      Preciso falar uma coisa… entrei aqui sem acreditar muito
                      não
                    </p>
                    <div className="text-[10px] text-zinc-400 text-right mt-1">
                      14:09
                ...
                <div className="flex justify-start">
                  <div className="bg-white rounded-t-xl rounded-br-xl rounded-bl-sm px-3 py-2 max-w-[85%] shadow-sm">
                    <p className="text-[13px] text-zinc-800 leading-snug">
                      Porque já tentei academia 3x e desisti toda vez por causa
                ...
                <div className="flex justify-start">
                  <div className="bg-white rounded-t-xl rounded-br-xl rounded-bl-sm px-3 py-2 max-w-[90%] shadow-sm">
                    <p className="text-[13px] text-zinc-800 leading-snug">
                      Fiz 3 semanas do plano e as dores sumiram. Meu marido
                      perguntou o que tava acontecendo porque to mais disposta
                      😂❤️
                    </p>
                    <div className="text-[10px] text-zinc-400 text-right mt-1">
                      14:11 ✓✓
                ...
                <div className="flex justify-end">
                  <div className="bg-[#dcf8c6] rounded-t-xl rounded-bl-xl rounded-br-sm px-3 py-2 max-w-[75%] shadow-sm">
                    <p className="text-[13px] text-zinc-800 leading-snug">
                      Que demais Pati!! Fico tão feliz 🥹🙌
                    </p>
                    <div className="text-[10px] text-zinc-400 text-right mt-1">
                      14:13 ✓✓
                    </div>
            ...
            >
              ...
              <div className="bg-[#e5ddd5] px-3 py-4 space-y-2">
                ...
                <div className="flex justify-start">
                  <div className="bg-white rounded-t-xl rounded-br-xl rounded-bl-sm px-3 py-2 max-w-[90%] shadow-sm">
                    <p className="text-[13px] text-zinc-800 leading-snug">
                      Nunca consegui isso com dieta. Com treino de 15 min em
                      casa funcionou de verdade 😭
                    </p>
                    <div className="text-[10px] text-zinc-400 text-right mt-1">
                      09:43 ✓✓
                    </div>
        ...
        <section className="px-5 py-10 bg-surface-subtle">
          ...
          <div className="space-y-3">
            {[
              ...
              <div
                key={i}
                className="border border-border rounded-xl overflow-hidden bg-surface-card"
              >
                <button
                  onClick={() => toggleFaq(i)}
        ...
        <section className="w-full bg-surface-card border-t border-border pt-6 pb-8 px-5 flex flex-col items-center">
          ...
          {!expired ? (
            <div className="inline-flex items-center gap-1.5 bg-status-error text-white text-[10px] font-black uppercase tracking-wide rounded-full px-3 py-1.5 mb-5 shadow-sm whitespace-nowrap">
              ...
              <span className="bg-white/20 rounded-full px-2 py-0.5 tabular-nums font-black">
                {m}:{s}
              </span>
            </div>
          ) : (
          ...
          <div className="w-full flex items-center justify-between mb-4 px-2">
            <div>
              ...
              <div className="font-heading font-black text-sm text-text-primary leading-tight">
                PLANO PASSO A PASSO
              </div>
          ...
          <p className="text-center text-[11px] text-text-secondary mt-3">
            🔒 Pagamento seguro • Garantia de 7 dias sem perguntas
          </p>
        </section>
      </div>
    </div>
