...
const reviewsRow1: Review[] = [
  {
    ...
    age: 41,
    location: "SP",
    text: "Voltei a colocar roupa sem pensar na barriga o dia inteiro.",
  },
  {
    name: "Fernanda",
    age: 33,
    location: "RJ",
    text: "10–15 min por dia e já senti diferença na postura.",
  },
  {
    name: "Juliana",
    age: 38,
    location: "BH",
    text: "Eu achava que precisava de academia. Em casa funcionou.",
  },
  {
    name: "Patrícia",
    age: 45,
    location: "Curitiba",
    text: "Comecei do zero, sem força. O plano foi no meu ritmo.",
  },
  {
    name: "Camila",
    age: 29,
    location: "Goiânia",
    text: "Minha energia à tarde melhorou MUITO nas primeiras semanas.",
  },
  {
    name: "Renata",
    age: 36,
    location: "Recife",
    text: "Me senti mais firme e confiante com as roupas.",
  },
  {
    name: "Marina",
    age: 34,
    location: "MG",
    text: "Nunca consegui fazer academia. Em 3 semanas senti o corpo firme.",
  },
  {
    name: "Luciana",
    age: 42,
    location: "SP",
    text: "Achei que ia ser difícil. Comecei do zero e as dores sumiram!",
  },
];
...
const reviewsRow2: Review[] = [
  {
    ...
    age: 34,
    location: "Salvador",
    text: "Parecia impossível manter constância. O plano deixou simples.",
  },
  {
    name: "Débora",
    age: 39,
    location: "Brasília",
    text: "As dores de ficar o dia sentada diminuíram com os exercícios.",
  },
  {
    name: "Bruna",
    age: 31,
    location: "POA",
    text: "Fiz sem equipamento. Só segui o passo a passo.",
  },
  {
    name: "Tatiane",
    age: 44,
    location: "Interior SP",
    text: "Eu vivia recomeçando. Dessa vez consegui manter.",
  },
  {
    name: "Amanda",
    age: 27,
    location: "Fortaleza",
    text: "Treino curto, objetivo e sem inventar moda.",
  },
  {
    name: "Sandra",
    age: 48,
    location: "Manaus",
    text: "Eu só precisava de um plano que coubesse na minha vida.",
  },
  {
    name: "Camila",
    age: 29,
    location: "RJ",
    text: "Os treinos de 15 minutos salvaram minha rotina.",
  },
  {
    name: "Rafaela",
    age: 27,
    location: "SC",
    text: "Melhor decisão que tomei. Com peso do corpo ganhei muita força.",
  },
];
    ...
    >
      ...
      <div className="flex items-center pointer-events-none mt-auto pl-1">
        <span className="text-[10px] text-zinc-500 leading-none truncate">
          <strong className="text-zinc-800 font-bold">{review.name}</strong> —{" "}
...
export function Step14_WallOfLove({ onContinue }: { onContinue: () => void }) {
  return (
    <section
      className="relative flex flex-col w-full min-w-0 max-w-full overflow-hidden"
    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none select-none">
        ...
        <div
          ...
          style={{ background: "rgba(250,249,246,0.2)" }}
        />
      </div>
      ...
      */}
      <div
        ...
        style={{
          height: "42%",
          background:
            "linear-gradient(to bottom, rgba(250,249,246,1) 0%, rgba(250,249,246,0.95) 25%, rgba(250,249,246,0.6) 75%, rgba(250,249,246,0) 100%)",
        }}
      />
      ...
      */}
      <div
        ...
        style={{
          height: "38%",
          background:
            "linear-gradient(to top, rgba(250,249,246,1) 0%, rgba(250,249,246,0.95) 30%, rgba(250,249,246,0.6) 75%, rgba(250,249,246,0) 100%)",
        }}
      />
